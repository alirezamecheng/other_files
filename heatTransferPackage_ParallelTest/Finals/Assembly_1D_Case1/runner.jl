...
function runs()
    ...
    # fontsize = 10
    # p = plot(x,FDM_Solution[1].T,label = "FDM t = $(solutionTimes[1])",legend=:topleft,legendfontsize=6,yguidefontsize=fontsize,xtickfontsize=fontsize,ytickfontsize=fontsize,xguidefontsize=fontsize,titlefontsize=fontsize)
